...
export default function Navbar() {
      useEffect(() => {
        ...
        if (tcLink && tcModal) {
          tcLink.addEventListener("click", (event) => {
            logAmplitudeEvent("TC_VIEW");
        ...
        return () => {
          ...
          if (tcLink) tcLink.removeEventListener("click", () => {});
        };
      }, []);
        ...
        <div className="nav_container xl:px-[200px] lg:px-[126px] px-[32px] lg:h-[87px] h-[64px] lg:rounded-b-[87px] fixed top-0 right-0 left-0 z-10">
            <div className="flex justify-between items-center h-full lg:mx-[42px]">
                ...
                <div className="relative lg:hidden block">
                    ...
                    <div id="id-mobile-nav-icon" className="absolute border-[0.5px] top-[42px] border-primary/20 rounded-[3px] bg-[#192935E0]">
